...
public class ListaProductos extends javax.swing.JDialog {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (filaSeleccinada == -1) {
            ...
            double isvPorProducto = (totalPorProducto - (totalPorProducto / 1.15));
            double subTotalPorProducto = (totalPorProducto - isvPorProducto);
            
            modelo = (DefaultTableModel) PanelVentas.jtablaProductosAVender.getModel();
            String elementosFila[] = {codigo, cantidad, descripcion, df.format((Double.parseDouble(precioVenta) / 1.15)), descuento, df.format(subTotalPorProducto), df.format(isvPorProducto), df.format(totalPorProducto)};
